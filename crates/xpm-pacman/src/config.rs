                    ...
                    for (k, l_v) in prop.iter() {
                        for v in l_v.iter() {
                            match k.as_str() {
                                ...
                                "RemoteFileSigLevel" => {
                                    cfg.remote_file_sig_level.push(v.to_string())
                                }
                                ...
                                "VerbosePkgList" => {
                                    cfg.verbose_pkg_list = v.parse().unwrap_or(false)
                                }
                                "DisableDownloadTimeout" => {
                                    cfg.disable_download_timeout = v.parse().unwrap_or(false)
                                }
                                _ => {}
                            }
                        }
